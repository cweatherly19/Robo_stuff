...
while True:
  ...
  print(pot_value_elbow * 270 / elbow_range) #to only use 180 degrees of the POT's range
  print(pot_value_elbow * 3 math.pi / (2 * elbow_range))
  time.sleep(0.1)
  print(pot_value_shoulder * 270 / shoulder_range) #to only use 180 degrees of the POT's range
